...
<style>
    ...
    *,
    ...
    .dropdown-item.nav_link {
        color: var(--first-color-light);
        padding: 0.5rem 0 0.5rem 2.5rem;
        font-size: 0.9rem;
    }
    
    .dropdown-item.nav_link:hover {
        background-color: transparent;
        color: var(--white-color);
    }
                ...
                <nav class="nav">
                    <div>
                        ...
                        <div class="nav_list nav">
                            ...
                            <div class="dropdown">
                                <a href="#" class="nav_link dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">
                                ...
                                <ul class="dropdown-menu">
                                    <li>
                                        <a class="dropdown-item nav_link"
                                           href="#"
                                           data-bs-toggle="tab"
                                           data-bs-target="#bukti-pekerjaan">
